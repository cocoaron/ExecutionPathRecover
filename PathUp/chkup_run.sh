...
SCRIPT_NAME="start"
SCRIPT_PATH="/PathUp/exec_pth_rec/jsparse"
...
file_paths=(
    "/firmware/extracted/RLC-410W_extracted"
    "/firmware/extracted/wa801nv1_en_3_12_6_up_bin_extracted"
    "/firmware/extracted/_WNR1000v2_V1_1_2_60NA_img_extracted"
)
...
do
    python3 main.py --firmware_path "$file_path" --results_path "./results"
done
