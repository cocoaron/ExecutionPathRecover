...
function doPortChange(check)
{
	if(check == 0)
	{
		if(top.forward_range_flag == 1 &&(top.is_ru_version==1 || top.is_pr_version==1))
			location.href="forwarding_range.htm";
		else
...
{// 0-9, a-z
	if (!(((each_char>47) && (each_char<58))||((each_char>96) && (each_char<123)) || (each_char==8)||(each_char==0)))
		return false;
}
